      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <div className="bg-gray-800/50 rounded-lg p-4">
            <h3 className="text-sm font-medium text-gray-300 mb-2">🔒 Informasi Login</h3>
            <ul className="text-xs text-gray-400 space-y-1">
              <li className="flex items-start">
                ...
                <span>Hanya admin yang sudah disetujui yang dapat login</span>
              </li>
              <li className="flex items-start">
                <svg className="w-3 h-3 mr-2 text-primary mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Hubungi Admin Ketua jika lupa password</span>
              </li>
              <li className="flex items-start">
                <svg className="w-3 h-3 mr-2 text-primary mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Pastikan akun sudah diverifikasi sebelum login</span>
              </li>
            </ul>
          </div>
        </div>
