...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen bg-linear-to-b from-gray-900 to-gray-800 pb-16"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="relative lg:w-1/2 h-full">
            ...
            <Image
              src="/assets/B1-AlKhawarizmi.webp"
              alt="Al Khawarizmi"
              width={768}
              height={768}
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-2xl md:text-3xl font-medium text-white mb-6">
              Perkumpulan Mahasiswa Islam dari Jurusan Informatika UPN
              Yogyakarta.
            </h2>
